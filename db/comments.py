...
comment_style = "`comments`(`commentid` BINARY(16)  NOT NULL PRIMARY KEY, `userid` BINARY(16) NOT NULL,  `questionid` BINARY(16) NOT NULL, `content` VARCHAR(200) NOT NULL, `time` DATE NOT NULL)"
